...
/**
 * Dashboard functionality tests with authenticated users using dynamic user generation.
 * Tests dashboard display, user information verification, logout, and authentication redirects.
 */
test.describe("Dashboard Flow", () => {
  /**
   * Verifies dashboard displays correctly with authenticated user information.
   */
  ...
  /**
   * Tests complete logout flow from dashboard to home page.
   */
  ...
  /**
   * Validates authenticated users are automatically granted dashboard access.
   */
